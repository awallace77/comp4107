...
class Encoder(torch.nn.Module):
    """
        Defines an encoder for an autoencoder 
    """
...
class Decoder(torch.nn.Module):
    """
        Defines a decoder for an autoencoder 
    """
...
class AutoEncoderNorm(torch.nn.Module):
    """
        Defines an auto encoder with normalization in [-1, 1]
    """
...
def get_preprocessing(name):
    """
        Returns different preprocessing
    """
...
def train_autoencoder(training_data_directory, transform):
    """
        A function that creates a cnn autoencoder model for images from the Linnaeus 5 dataset with a provided transform for preprocessing
    """
...
def train_autoencoder_norm(training_data_directory, transform):
    """
        A function that creates a cnn autoencoder model for images from the Linnaeus 5 dataset with normalization in [-1, 1]
    """
...
def linnaeus5_autoencoder_test(model, test_data_directory):
    """
        To test a trained linnaeus5 autoencoder
    """
...
def run_experiments(training_data_directory):
    """
        Runs experiments for q3 and q4
    """
    ...
    for exp in experiments2:
        print(f"\nRunning normalized experiments2: {exp}")
